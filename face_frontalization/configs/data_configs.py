...
DATASETS = {
	...
	'ffhq_frontalize': {
		...
		'train_source_root': dataset_paths['ffhq_s'],
		'train_target_root': dataset_paths['ffhq_t'],
		'test_source_root': dataset_paths['ffhq_test_s'],
		'test_target_root': dataset_paths['ffhq_test_t'],
	},
